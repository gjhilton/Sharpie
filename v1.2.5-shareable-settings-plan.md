...
#### Task 1.6: Implement QR code generation

- [ ] Install QR code library (e.g., `qrcode` or `qrcode.react`)
- [ ] Add QR code generation button/toggle next to copy button
- [ ] Generate QR code from shareable URL
- [ ] Display QR code in modal or inline
- [ ] Add download option for QR code image
- [ ] Style QR code display appropriately
- [ ] Test QR code scanning on mobile devices
- [ ] Add loading state while generating QR code

#### Task 1.7: Implement reset to defaults button

- [ ] Add "Reset to defaults" button to OptionsSummary
- [ ] Import `getDefaults()` from `@lib/options/defaults.js`
- [ ] On click, call options context setter with default values
- [ ] Add confirmation dialog (optional: "Are you sure?")
- [ ] Show success feedback after reset
- [ ] Verify all options reset correctly
- [ ] Update badges immediately after reset
- [ ] Add appropriate icon/styling for reset button
...
- [ ] Test QR code button click
- [ ] Test QR code generation with correct URL
- [ ] Test QR code modal/display toggle
- [ ] Test QR code download functionality
- [ ] Test reset to defaults button click
- [ ] Mock options context setter and verify it's called with defaults
- [ ] Test reset success feedback
...
- [ ] Verify all settings return to default state after reset
- [ ] Verify reset confirmation dialog if implemented
...
- [ ] Story: QR code display
- [ ] Story: Reset to defaults interaction
...
- [ ] Add entry to `src/data/changelog.json`:
    ...
    {
    	"version": "1.2.5",
    	"description": "Shareable settings: Options section now displays current settings as visual badges with a shareable URL, QR code generation for mobile sharing, copy-to-clipboard functionality, and a reset to defaults button, making it easy to share and manage game configurations."
    }
    ```
...
│ └────────────────────────────────────┘                  │
│ [Copy] [QR Code] [Reset to Defaults]                   │
└──────────────────────────────────────────────────────────┘
```
...
- **Existing code to leverage:**
    ...
    - `src/lib/options/defaults.js` - `getDefaults()`
...
- **New npm packages needed:**
    - QR code library: `qrcode` or `qrcode.react` or `react-qr-code` (to be evaluated)
...
- [ ] Click QR code button → verify QR code displays
- [ ] Scan QR code with mobile device → verify it loads correct URL
- [ ] Download QR code → verify image file is saved correctly
- [ ] Click reset to defaults → verify all settings reset
- [ ] Verify reset confirmation dialog works (if implemented)
...
- QR codes successfully scan and load correct settings
- Reset to defaults properly restores all default settings
