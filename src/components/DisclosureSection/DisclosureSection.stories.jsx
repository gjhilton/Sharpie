...
export const Collapsed = {
	args: {
		...
		children: (
			<p>
				This is the content that will be revealed when the section is
				expanded. It can contain any React components.
			</p>
		),
	},
};
...
export const LongTitle = {
	args: {
		...
		children: (
			<p>
				Additional resources and suggestions for continuing your
				learning journey after mastering the basics.
			</p>
		),
	},
};
	...
	return (
		<div>
			<DisclosureSection title="Options" defaultExpanded={false}>
				<p>
					Game configuration options including mode selection and
					alphabet choices.
				</p>
			</DisclosureSection>
			<DisclosureSection title="How to play" defaultExpanded={false}>
				<p>
					Instructions on gameplay, letter identification, and using
					hints.
				</p>
			</DisclosureSection>
			<DisclosureSection
	...
	return (
		<div>
			<p className={css({ marginBottom: '1rem' })}>
				Click on section headers to expand/collapse them. Currently
				expanded: <strong>{expandedSection || 'None'}</strong>
			</p>
