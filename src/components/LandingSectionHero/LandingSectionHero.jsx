		...
		<>
			...
			>
				...
				<div>
					...
					<Button hero onClick={onSelectMode} label="Play" />
				</div>
			</div>
			<div>
				<DisclosureSection title="Options">
							...
							>
								...
								>
									<input
										...
										checked={gameMode === GAME_MODES.ALL}
										onChange={e =>
											setOption(
												'gameMode',
												e.target.value
					...
					<SubSection title="Alphabets">
						<Paragraph>
							...
							characters from{' '}
							<strong>
								{db.countEnabledAlphabets(enabledAlphabets)}
							</strong>{' '}
							alphabets.
						</Paragraph>
						<Button
							label="Choose alphabets"
